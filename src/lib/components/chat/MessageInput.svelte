				...
				<div class="">
					...
					>
						<div
							...
							class="{recording ? 'hidden' : ''} flex-1 flex flex-col relative w-full shadow-lg rounded-3xl border {$temporaryChatEnabled
						...
						>
							...
							<div class=" flex justify-between mt-0.5 mb-2.5 mx-0.5 max-w-full" dir="ltr">
								...
								<div class="self-end flex space-x-1 mr-1 shrink-0">
									{#if (!recording) && (!history?.currentId || history.messages[history.currentId]?.done == true) && ($_user?.role === 'admin' || ($_user?.permissions?.chat?.stt ?? true))}
										<!-- {$i18n.t('Record voice')} -->
